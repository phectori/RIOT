...
static int read_temperature(void *dev, phydat_t *res)
{
    ...
    res->scale = -2;    /* TODO. Is this correct? The BME function gives us centi Celcius. */
...
static int read_relative_humidity(void *dev, phydat_t *res)
{
    ...
    res->scale = -2;    /* TODO. Is this correct? The BME function gives us centi percentage. */
...
static int read_pressure(void *dev, phydat_t *res)
{
    ...
    res->unit = UNIT_PA;
    res->scale = 2;     /* TODO. Is this correct? The BME function gives us Pa and we divide to get hPa. */
